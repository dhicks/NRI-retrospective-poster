\documentclass[paperheight = 24in, paperwidth = 36in, margin = 1in, 
...
\headerbox{References}{name = references, column = 0, below = stats}{
	\begin{itemize}
		\item ref1
		\item ref2
		\item ref3
...
\headerbox{}{name = logo, column = 0, below = references}{
\begin{center}
